...
describe ForexReportsController do
  describe 'GET search' do
    it 'should search forex payments for given params' do
      forex_payments_1 = FactoryGirl.create(:forex_payment, :vendor_name => 'A', :currency => 'USD', :issue_date => Date.parse('31-12-2011'))
      forex_payments_2 = FactoryGirl.create(:forex_payment, :vendor_name => 'B', :currency => 'USD', :issue_date => Date.parse('31-12-2011'))
      forex_payments_3 = FactoryGirl.create(:forex_payment, :vendor_name => 'B', :currency => 'EUR', :issue_date => Date.parse('31-12-2011'))
