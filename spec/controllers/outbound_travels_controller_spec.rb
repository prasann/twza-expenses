...
describe OutboundTravelsController do
  ...
  # OutboundTravel. As you add validations to OutboundTravel, be sure to
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested outbound_travel" do
        outbound_travel = OutboundTravel.create! valid_attributes
        # Assuming there are no other outbound_travels in the database, this
        # specifies that the OutboundTravel created on the previous line
