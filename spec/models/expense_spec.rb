...
describe Expense do
  ...
  describe "fetch_for_employee_between_dates" do
    it 'should be able to fetch reimbursable expenses for an employee between dates' do
      ...
      expense_2 = Factory(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-15'))
      expense_3 = Factory(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-20'))
      expense_4 = Factory(:expense, :empl_id => 124, :expense_date => Date.parse('2011-12-14'))
      expense_5 = Factory(:expense, :empl_id => 125, :expense_date => Date.parse('2011-12-14'))
