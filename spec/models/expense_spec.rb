...
describe Expense do
  ...
  describe "fetch_for_employee_between_dates" do
    it 'should be able to fetch reimbursable expenses for an employee between dates' do
      expense_1 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-14'), :payment_type => 'Personal Cash or Check')
      expense_2 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-15'))
      expense_3 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-20'))
      expense_4 = FactoryGirl.create(:expense, :empl_id => 124, :expense_date => Date.parse('2011-12-14'))
      expense_5 = FactoryGirl.create(:expense, :empl_id => 125, :expense_date => Date.parse('2011-12-14'))
    ...
    it 'should not fetch reimbursable expenses of payment type TW Billed by Vendor' do
      expense_1 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-14'), :payment_type => 'TW Billed by Vendor')
      expense_2 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-15'), :payment_type => 'Personal Cash or Check')
      expense_3 = FactoryGirl.create(:expense, :empl_id => 123, :expense_date => Date.parse('2011-12-20'))
      expense_4 = FactoryGirl.create(:expense, :empl_id => 124, :expense_date => Date.parse('2011-12-14'))
      expense_5 = FactoryGirl.create(:expense, :empl_id => 125, :expense_date => Date.parse('2011-12-14'))
      actual_result = Expense.fetch_for_employee_between_dates(123, Date.new(y=2011,m=12,d=14), Date.new(y=2011,m=12,d=16),[])
